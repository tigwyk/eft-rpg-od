            ...
            case "blessing":
                ...
                if (eventRoll == 1) {
                    ...
                    document.querySelector("#choice1").onclick = function () {
                        if (player.gold < cost) {
                            sfxDeny.play();
                            addDungeonLog("You don't have enough roubles.");
                        } else {
                            player.gold -= cost;
                            sfxConfirm.play();
                            statBlessing();
...
const nothingEvent = () => {
    ...
    if (eventRoll == 1) {
        ...
        addDungeonLog("You found a dead scav.");
    } else if (eventRoll == 4) {
        addDungeonLog("You found a PMC body.");
    } else if (eventRoll == 5) {
...
const cursedTotem = (curseLvl) => {
    ...
    addDungeonLog(`The scavs in the raid became stronger and the loot quality improved. (Curse Lv.${curseLvl} > Curse Lv.${curseLvl + 1})`);
    saveData();
}
